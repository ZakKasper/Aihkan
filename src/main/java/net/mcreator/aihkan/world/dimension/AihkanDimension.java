...
import net.mcreator.aihkan.item.AihkanItem;
...
public class AihkanDimension extends AihkanModElements.ModElement {
	@ObjectHolder("aihkan:aihkan")
	public static final ModDimension dimension = null;
	@ObjectHolder("aihkan:aihkan_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public AihkanDimension(AihkanModElements instance) {
		super(instance, 7);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("aihkan"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("aihkan:aihkan")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("aihkan:aihkan"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("aihkan:aihkan"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new AihkanItem().setRegistryName("aihkan"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = AihkanDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("aihkan_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "aihkan_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = AihkanDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
