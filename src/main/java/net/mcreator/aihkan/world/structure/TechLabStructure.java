...
public class TechLabStructure extends AihkanModElements.ModElement {

	public TechLabStructure(AihkanModElements instance) {
		super(instance, 113);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("aihkan", "tech_lab"));
