	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure SciTowerAdditionalGenerationCondition!");
			return;
		}
		...
		if ((((Entity) world
			...
			}
			{
				...
				SciTowerOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
