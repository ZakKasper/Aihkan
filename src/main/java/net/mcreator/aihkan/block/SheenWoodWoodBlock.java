...
public class SheenWoodWoodBlock extends AihkanModElements.ModElement {
	@ObjectHolder("aihkan:sheen_wood_wood")
	public static final Block block = null;
	public SheenWoodWoodBlock(AihkanModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sheen_wood_wood");
		}
