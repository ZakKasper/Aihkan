...
public class MagicWoodSlabBlock extends AihkanModElements.ModElement {
	@ObjectHolder("aihkan:magic_wood_slab")
	public static final Block block = null;
	public MagicWoodSlabBlock(AihkanModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("magic_wood_slab");
		}
