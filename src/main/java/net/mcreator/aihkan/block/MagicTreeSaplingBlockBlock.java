...
import net.mcreator.aihkan.procedures.MagicTreeSaplingBlockUpdateTickProcedure;
import net.mcreator.aihkan.procedures.MagicTreeSaplingBlockOnBlockRightClickedProcedure;
import net.mcreator.aihkan.procedures.MagicTreeSaplingBlockBlockAddedProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
			{
				...
				MagicTreeSaplingBlockBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MagicTreeSaplingBlockUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MagicTreeSaplingBlockOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
