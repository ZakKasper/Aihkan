...
public class WastelandDirtBlock extends AihkanModElements.ModElement {
	@ObjectHolder("aihkan:wasteland_dirt")
	public static final Block block = null;
	public WastelandDirtBlock(AihkanModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wasteland_dirt");
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("wasteland_dirt", "wasteland_dirt", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 10)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(3, 0, 0, 100))));
		}
	}
}
