...
public class SheenWoodFenceGateBlock extends AihkanModElements.ModElement {
	@ObjectHolder("aihkan:sheen_wood_fence_gate")
	public static final Block block = null;
	public SheenWoodFenceGateBlock(AihkanModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("sheen_wood_fence_gate");
		}
